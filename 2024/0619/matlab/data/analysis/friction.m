% シミュレーションデータから取得したdp(方向のデータ)を方向付き摩擦力に置き換える
% 結果は.mat形式で出力
...
position_vector = [0.0, -0.0125, 0.0350, 0.0, 0.035, 0.0125, 0.0350, -0.0125, -0.0350, 0.0, -0.035, 0.0125, -0.0350, 0.0, 0.015, 0.0, -0.015];
