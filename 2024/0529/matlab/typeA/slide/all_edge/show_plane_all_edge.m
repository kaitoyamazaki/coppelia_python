...
openfig('../graph_data/all_edge.fig');
...
[wrench1_x, wrench1_y, wrench1_z] = make_plane_f1_f2(l1, l2, l3);
[wrench2_x, wrench2_y, wrench2_z] = make_plane_f2_f3(l1, l2, l3);
[wrench3_x, wrench3_y, wrench3_z] = make_plane_f3_f1(l1, l2, l3);


mesh1 = mesh(wrench1_x, wrench1_y, wrench1_z, 'FaceColor', 'b', 'LineStyle', 'none', 'FaceAlpha', 0.25);
mesh2 = mesh(wrench2_x, wrench2_y, wrench2_z, 'FaceColor', 'b', 'LineStyle', 'none', 'FaceAlpha', 0.25);
mesh3 = mesh(wrench3_x, wrench3_y, wrench3_z, 'FaceColor', 'b', 'LineStyle', 'none', 'FaceAlpha', 0.25);
