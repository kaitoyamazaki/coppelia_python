...
function [p1, p2, p3, p, box1, box2, box3, box4, wrench1, wrench2, wrench3, wrench] = show_all_edge(i, j, l1, f1, l2, f2, l3, f3)
    ...
    box2 = annotation('textbox', [0.0, 0.85, 0.1, 0.1], 'String', sprintf('f2 = (%.4f, %.4f, %.4f)', wrench2(1), wrench2(2), wrench2(3)), 'FitBoxToText', 'on', 'Color', [1.0, 0.65, 0.0], 'EdgeColor', 'none', 'FontSize', 12);
