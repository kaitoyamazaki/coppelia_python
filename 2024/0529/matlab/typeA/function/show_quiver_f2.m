...
function [p, text_box, wrench] = show_quiver_f2(i, f, l)
    % 関数を動かすために返り値を記述
    h = 0;
    ...
    text_box = annotation('textbox', [0.0, 0.9, 0.1, 0.1], 'String', sprintf('f2 = (%.4f, %.4f, %.4f)', wrench(1), wrench(2), wrench(3)), 'FitBoxToText', 'on', 'Color', 'k', 'EdgeColor', 'none', 'FontSize', 12);
end