...
function [p1, p2, p3, p, box1, box2, box3, box4, wrench1, wrench2, wrench3, wrench] = show_f3_f1_edge(i, l1, f1, l2, f2, l3, f3)
    ...
    box1 = annotation('textbox', [0.0, 0.9, 0.1, 0.1], 'String', sprintf('f1 = (%.4f, %.4f, %.4f)', wrench1(1), wrench1(2), wrench1(3)), 'FitBoxToText', 'on', 'Color', [0.8, 0.8, 0.0], 'EdgeColor', 'none', 'FontSize', 12);
    box2 = annotation('textbox', [0.0, 0.85, 0.1, 0.1], 'String', sprintf('f2 = (%.1f, %.1f, %.1f)', wrench2(1), wrench2(2), wrench2(3)), 'FitBoxToText', 'on', 'Color', [1.0, 0.65, 0.0], 'EdgeColor', 'none', 'FontSize', 12);
    box3 = annotation('textbox', [0.0, 0.80, 0.1, 0.1], 'String', sprintf('f3 = (%.4f, %.4f, %.4f)', wrench3(1), wrench3(2), wrench3(3)), 'FitBoxToText', 'on', 'Color', [0.5, 0.0, 0.5], 'EdgeColor', 'none', 'FontSize', 12);
