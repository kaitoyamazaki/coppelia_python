...
class Path:
    ...
    def get_contact_point_position(self, sim):
        ...
        c_p_1 = contact_point1_pos_numpy - object_cog_pos_numpy
        c_p_2 = contact_point2_pos_numpy - object_cog_pos_numpy
        c_p_3 = contact_point3_pos_numpy - object_cog_pos_numpy
