...
%quiver(7.5, 30, 0.0, 10.0, 'Color', 'k', 'LineWidth', 2.0);
%quiver(5.0, 27.5, -10.0, 0.0, 'Color', 'k', 'LineWidth', 2.0);
%quiver(-13.5, 30, 0.0, 10.0, 'Color', 'k', 'LineWidth', 2.0);
...
for i=1:rows(1);
    ...
    h3 = quiver(-13.5, 30, 0.0, edit_gamma, 'Color', 'k', 'LineWidth', 2.0, 'AutoScale', 'off');
    pause(0.20);
    delete(h1);
    delete(h2);
    delete(h3);
